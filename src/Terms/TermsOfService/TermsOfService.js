  ...
  return (
    <div className="terms__container">
      ...
      <div className="termsOfService-box">
        ...
        <p>
          This website is operated by EntàMarket. Throughout the site, the terms
          “we”, “us” and “our” refer to EntàMarket. EntàMarket offers this
          ...
          terms, conditions, policies and notices stated here. <br /> <br />
          ...
          website or use any Services. <br /> <br /> If these Terms of Service
          ...
          current site shall also be subject to the Terms of Service. You can
          ...
          posting of any changes constitutes acceptance of those changes. Our
          site is hosted on AWS Cloud Hosting, which allows us to offer fast and
          better ecommerce services. <br /> <br />
      ...
      <div className="termsOfService-box">
        ...
        <p>
          ...
          <br /> <br /> Credit card information is always encrypted during
          transfer over networks. You agree not to reproduce, duplicate, copy,
      ...
      <div className="termsOfService-box">
        ...
        <p>
          ...
          <br /> <br /> We reserve the right to discontinue any product at any
      ...
      <div className="termsOfService-box">
        ...
        <p>
          ...
          same billing and/or shipping address. <br />
          <br />
          ...
          account information for all purchases made at our site. <br /> <br />
      ...
      <div className="termsOfService-box">
        ...
        <p>
          ...
          include materials from third-parties. <br /> <br /> Third-party links
      ...
      <div className="termsOfService-box">
        ...
        <p>
          ...
          <br /> <br /> We may, but have no obligation to, monitor, edit or
      ...
      <div className="termsOfService-box">
        ...
        <p>
          ...
          notice (including after you have submitted your order). <br /> <br />
      ...
      <div className="termsOfService-box">
        ...
        <p>
          ...
          notice to you. <br /> <br /> You expressly agree that your use of, or
          ...
          <br />
          In no case shall EntàMarket, our directors, officers, employees,
          ...
          possibility. <br /> <br /> Because some states or jurisdictions may
      ...
      <div className="termsOfService-box">
        ...
        <p>
          You agree to indemnify, defend and hold harmless EntàMarket and our
